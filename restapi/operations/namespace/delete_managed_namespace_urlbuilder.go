...
func (o *DeleteManagedNamespaceURL) Build() (*url.URL, error) {
	...
	if customer != "" {
		...
		return nil, errors.New("customer is required on DeleteManagedNamespaceURL")
	}
	...
	if name != "" {
		...
		return nil, errors.New("name is required on DeleteManagedNamespaceURL")
	}
...
func (o *DeleteManagedNamespaceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteManagedNamespaceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteManagedNamespaceURL")
	}
